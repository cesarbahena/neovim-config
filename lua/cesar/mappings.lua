...
utils.remap{
  ...
  i = {
    ...
    { '<C-o>dw', '<C-w>', 'Delete word forward' },
    { '<BS>', '<C-u>', 'Backspace' },
    { '<Del>', '<C-x>', 'Delete' },
    { '<C-w>', { colemak = '<C-k>', qwerty = '<C-b>' }, 'Delete word backwards' },
    { '<Esc>%%a', { colemak = '<C-h>', qwerty = '<C-j>' }, 'Next (afer parentheses)' },
    { '<Esc>la,<space>', { colemak = '<C-o>', qwerty = '<C-l>' }, 'Comma after string' },
    { "<Esc>:m+<CR>==gi", '<C-d>', 'Move line down' },
    { "<Esc>:m-2<CR>==gi", '<C-s>', 'Move line up' },
  },
  v = {
    { '<Esc>', { colemak = '<C-e>', qwerty = '<C-k>' }, 'Escape to normal mode' },

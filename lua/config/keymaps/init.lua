...
return {
  ...
  normal("Delete line ", fn('actions.delete_line_no_yank_blankline'), { expr = true, details = [[(don't yank blankline)]]}),
  normal('Indent', '>>'),
  normal('Deindent', '<<'),
  ...
  insert("Escape to normal mode", "<C-c>"),
  ...
  command('Escape to normal mode', '<c-c>'),

...
local mappings_to_disable = {
  ...
  ']l', -- location list
  '[L',
  ']L', -- location list (first/last)
  '[b',
  ']b', -- buffers
  '[B',
  ']B', -- buffers (first/last)
  '[a',
  ']a', -- args
  '[A',
  ']A', -- args (first/last)
  ...
  ']<Tab>', -- indent
  '[<C-L>',
  ']<C-L>', -- control-L variants
  '[<C-Q>',
  ']<C-Q>', -- control-Q variants
  '[<C-T>',
  ']<C-T>', -- control-T variants
  'gh',
}

...
return {
...

  {
    ...
    keys = {
        ...
        { desc = "Indentation and lines above/below", "ai", VTO:format[[indentation('outer', 'outer')]], mode = { 'o', 'x' } },
        ...
        { desc = "Subword", "iz", function() vim.print('Hello') return VTO:format[[subword 'inner']] end, expr= true, mode = { 'o', 'x' } },
        { desc = "Subword and hyphens", "az", VTO:format[[subword 'outer']], mode = { 'o', 'x' } },

        { desc = "Next Subword", "z", function()
          require("mini.ai").move_cursor('left', 'i', 'Z', { search_method = 'next' })
        end, mode = { 'n', 'x', 'o' } },
        { desc = "Next Subword", "Z", function()
          require("mini.ai").move_cursor('left', 'i', 'Z', { search_method = 'prev' })
        end, mode = { 'n', 'x', 'o' } },
        ...
        { desc = "Line characterwise with indentation and trailing space", "a_", VTO:format[[lineCharacterwise 'outer']], mode = { 'o', 'x' } },
        ...
        { desc = "CSS selector with trailing comma and space", "aS", VTO:format[[cssSelector 'outer']], mode = { 'o', 'x' } },
